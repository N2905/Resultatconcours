<form id="form_cand" method="post" action="<?= base_url('Candidat/save'); ?>">
	<div class="row">
	<legend>Formulaire candidat</legend>
	<section class="col-md-6">
	<div class="form-group">
	<label>Nom <sup>*</sup> :</label>
	<input type="text" name="nom_cand" class="form-control _ucfirt required">
	</div>
	<div class="form-group">
	<label>Prenom:</label>
	<input type="text" name="prenom_cand" class="form-control _ucfirt" >
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input id="cin_cand" type="text" name="cin_cand" class="form-control required _numberonly required">
    </div>
    <div class="form-group">
		<div class="col-md-6" style="padding-left: 0px">
			<label for="cand_lieu_cin">Fait à <sup>*</sup> :</label>
			<input id="cand_lieu_cin" type="text" name="cand_lieu_cin" class="form-control _ucfirt required">
		</div>
		<div class="col-md-6"  style="padding-right: 0px">
			<label for="cand_du_cin">le <sup>*</sup> :</label>
			<input id="cand_du_cin" type="text" name="cand_du_cin" class="form-control required">
		</div>
	</div>
	<div class="form-group">
	<label>Date obtention baccaleaureat <sup>*</sup> :</label>
	<input id="cand_anne_bac" type="text" name="cand_anne_bac" class="form-control required">
    </div>
    <div class="form-group">
	<label>Numero bacc <sup>*</sup> :</label>
	<input type="text" name="cand_num_bac" class="form-control required">
    </div>
    <div class="form-group">
	...
	<div class="form-group">
	 	...
	 	<select name="parc_id" class="form-control">
    ...
    <section class="col-md-6">
    	<div class="form-group">
			...
			<input id="email_cand" type="text" name="email_cand" class="form-control">
		 </div>
		 <div class="form-group">
			<label for="cand_indication">Indication baccaleaureat :</label>
			<input id="cand_indication" type="text" name="cand_indication" class="form-control">
		 </div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input id="cand_nationalite" type="text" name="cand_nationalite" class="form-control _ucfirt">
		 </div>
		 <div class="form-group">
			<label for="cand_pays">Pays :</label>
			<input id="cand_pays" type="text" name="cand_pays" class="form-control _ucfirt">
		 </div>
		 <div class="form-group">
			<label for="cand_ville">Ville :</label>
			<input id="cand_ville" type="text" name=" cand_ville" class="form-control _ucfirt">
		 </div>
		 <div class="form-group">
			<label for="cand_codepostale">Code postale :</label>
			<input id="cand_codepostale" type="text" name="cand_codepostale" class="form-control _numberonly">
		 </div>
		  <div class="form-group">
			<label for="anne-acc">Année Accademique :</label>
			<input id="anne_acc" type="year" name="anne_acc" class="form-control _numberonly">
		 </div>
    </section>
    </div>
