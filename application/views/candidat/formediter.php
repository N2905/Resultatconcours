...
<form method="post" action="<?= base_url('Candidat/modifier'); ?> " >
	...
	<label>ID:</label>
	<input type="text" name="cand_id" class="form-control" value="<?= $data->cand_id; ?>">
	</div>
	<div class="form-group">
	<label>Nom:</label>
	<input type="text" name="nom_cand" class="form-control" value="<?= $data->nom_cand; ?>">
	</div>
	<div class="form-group">
	<label>Prenom:</label>
	<input type="text" name="prenom_cand" class="form-control" value="<?= $data->prenom_cand; ?>" >
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input id="cin_cand" type="text" name="cin_cand" class="form-control required" value="<?= $data->cin_cand; ?>">
    </div>
    <div class="form-group">
		<div class="col-md-6" style="padding-left: 0px">
		...
		<div class="col-md-6"  style="padding-right: 0px">
			...
			<input id="cand_du_cin" type="text" name="cand_du_cin" class="form-control" value="<?= $data->cand_du_cin; ?>">
		</div>
	</div>
	<div class="form-group">
	<label>Date obtention baccaleaureat:</label>
	<input type="text" name="cand_anne_bac" class="form-control" value="<?= $data->cand_anne_bac; ?>" >
    </div>
   <div class="form-group">
	<label>Numero bacc:</label>
	<input type="text" name="cand_num_bac" class="form-control" value="<?= $data->cand_num_bac; ?>" >
    </div>
     <div class="form-group">
    ...
    <section class="col-md-6">
    	<div class="form-group">
			...
			<input id="email_cand" type="text" name="email_cand" class="form-control required" value="<?= $data->email_cand; ?>">
		 </div>
		 <div class="form-group">
			<label for="cand_indication">Indication baccaleaureat :</label>
			<input id="cand_indication" type="text" name="cand_indication" class="form-control required" value="<?= $data->cand_indication; ?>">
		 </div>
		<div class="form-group">
					<label>Série: </label>
		...
		<div class="form-group">
			...
			<input id=" cand_nationalite" type="text" name="cand_nationalite" class="form-control required" value="<?=$data->cand_nationalite;?>">
		 </div>
		 <div class="form-group">
			<label for="cand_pays">Pays :</label>
			<input id="cand_pays" type="text" name="cand_pays" class="form-control required" value="<?= $data->cand_pays; ?>">
		 </div>
		 <div class="form-group">
			<label for="cand_ville">Ville :</label>
			<input id="cand_ville" type="text" name="cand_ville" class="form-control required" value="<?= $data->cand_ville; ?>">
		 </div>
		 <div class="form-group">
